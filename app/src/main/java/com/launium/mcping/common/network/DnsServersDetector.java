package com.launium.mcping.common.network;
...
public class DnsServersDetector {
    ...
    @Nullable
    public String[] getServersNoFallback() {
    ...
    public String[] getServers() {
        ...
        String[] servers = getServersNoFallback();

        return servers == null ? FACTORY_DNS_SERVERS : servers;
